...
const usersRequester = require('@libs/requesters/buyer/user-requesters/user-requesters');
...
router.post('/login', async (req, res) => {
    try {
        ...
        logger.error("Error in Buyer users/login:", err.message);
...
router.post('/logout', async (req, res) => {
    try {
        ...
        logger.error("Error in users/buyer-logout:", err.message);
