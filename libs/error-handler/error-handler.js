...
// const handleCaseError = err => new AppError(`Invalid ${err.path}: ${err.value}.`, 400, []);
// const handleTokenExpiryError = () => new AppError('Authorization or session expired, please login again', 401, []);
// const handleNoAuthorizationProvidedError = () => new AppError('No Authorization provided', 401, []);
...
//   // Handle duplicate key (MongoDB-style)
